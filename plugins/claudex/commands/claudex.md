...
```bash
codex exec --sandbox read-only [--model <name>] [--cd <dir>] [-c model_reasoning_effort=<level>] -c model_verbosity=low - < <resolved-call-dir>/<filename>
```
